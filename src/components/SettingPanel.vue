    ...
    <div class="mdui-dialog" id="setting-dialog" ref="setting_dialog">
      ...
      <div class="mdui-dialog-content">
        <div class="mdui-textfield mdui-textfield-floating-label" id="stting_ws_host">
          ...
          <input class="mdui-textfield-input" v-model:value="ws_host" name="ws_host" type="url" ref="ws_host" pattern="(ws|wss):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?" required/>
        ...
        <div class="mdui-textfield mdui-textfield-floating-label" id="stting_ws_token">
          ...
          <input class="mdui-textfield-input" type="text" name="ws_token" v-model:value="ws_token"/>
...
export default {
  ...
  watch: {
    ws_host: function(new_value, old_value) {
